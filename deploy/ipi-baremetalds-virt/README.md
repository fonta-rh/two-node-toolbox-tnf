...
**High Level Diagrams of Deployment**
...
- This process will take a while, so be prepared for it to run for some time. The sample inventory.ini provided already accounts for this and provides an Ansible variable to keep the SSH connection alive. 
