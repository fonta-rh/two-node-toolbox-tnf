...
To verify your environment is setup properly, try sourceing the instance.env and ensure it doesn't throw errors.
```bash
source ./instance.env
```
...
This will leave you in a command prompt for the EC2 instance.
```bash
